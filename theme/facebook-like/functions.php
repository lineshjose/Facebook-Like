...
//----------------------------------------------------- Theme admin section -------------------------------------------------------//
	...
	global $themename, $shortname, $options;
		...
		add_theme_page('Page title', 'Facebook-like settings', 10, 'twitter-like', 'linesh_header');
	...
	<img src="<?php bloginfo('template_url'); ?>/screenshot.png" alt="Facebook-like "  style="margin-right:10px;border:1px solid #aaa;padding:5px;float:left;width:250px;" />
	<p>Thanks for downloading <strong>  Facebook-like  </strong> by Linesh Jose. Hope you enjoy using it!</p>
	...
	<p>A lot of hard work went in to programming and designing <strong> Facebook-like </strong>, and if you would like to support Linesh Jose (the guy who designed it) please use the donate link below.</p>
	...
	If you have any questions, comments, or if you encounter a bug, please <a href="http://lineshjose.info/">contact me</a>.
	</form>
