	...
	*/?>
	...
	<a href="javascript:void();" onclick="bookmark('<?php echo get_pagenum_link(); ?>', '<?php wp_title(''); ?><?php if(wp_title('', false)) { echo ' - '; } ?><?php bloginfo('name'); if(is_home()) { echo ' - '; bloginfo('description'); } ?>');"  >
	<img src="<?php echo  get_stylesheet_directory_uri();?>/images/bookmark.png" alt="Favorite" title="Add to Favorite"></a>
	</div>
